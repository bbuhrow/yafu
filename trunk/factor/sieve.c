...
#define SIEVE_TWO_PRIME_1  \
	...
	"andl	$0xffff, %%edi \n\t" \
		...
		"psrldq	$2,%%xmm1 \n\t" \
 		...
 		"subb   %%sil,0x0(%%r13,%%rbx,1) \n\t" \
		"1:  \n\t"								/* update roots */ \
 		"leaq   0xffffffffffff8000(%%r9),%%r14 \n\t" \
		"psrldq	$2,%%xmm2 \n\t" \
 		"leaq   0xffffffffffff8000(%%rdi),%%r15 \n\t" \
		"psrldq	$2,%%xmm3 \n\t" \
		"jmp	3f \n\t" \
		"2: \n\t"								/* swap roots */ \
 		"movl   %%edi,%%edx \n\t" \
...
//	for (i=start_prime;i<med_B;i++)
	...
	//{
	//	FILE *test;
	//	test = fopen("x2_dump_sieve.txt","w");
	//	fprintf(test,"\n\n");
	...
	//	test = fopen("x2_dump_roots.txt","w");
	//	fprintf(test,"\n\n");
	//	for (i=0; i<med_B; i++)

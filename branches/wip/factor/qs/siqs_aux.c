...
void get_params(static_conf_t *sconf)
{
    ...
    int param_table[NUM_PARAM_ROWS][4] = {
        ...
        {248,	26379,	90,	3},
        {265,	47158,	90,	4},         // 80 digits
        {281,	60650,	100,	4},
        {298,	71768,	120,	4},     // 90 digits
        {310,	86071 ,	120,	5},
        {320,	99745 ,	140,	5},     // 95 digits
        {330,	115500, 150,    6},     // 100 digits 
        {340,	138600, 150,    6},     // above 100 it is basically guesswork
        {350,	166320, 150,    7},     // 105 digits
        {360,   199584, 150,    7},
        {370,	239500, 150,    8},     // 110 digits
        {380,	287400, 175,    8},
        {390,	344881, 175,    9},
        {400,	413857, 175,    10},
        {410,	496628, 175,    11},
